  ...
  const collectionItems = orders.map(order => {
    ...
    <div className='flex justify-between'>
      <div className='flex flex-col justify-end'>
        { order.fulfillmentCriteria.coin.amount != '0' && <div>{ formatEther(BigInt(order.fulfillmentCriteria.coin.amount)) } ETH</div>}
  ...
  return (
    <div>
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex space-x-1'><div>My Items</div><input type='checkbox' /></div>
      </div>
      <div className='flex justify-between'>
        <div>
