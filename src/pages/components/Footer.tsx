...
export function Footer() {
  const felipeLinkedin = 'https://www.linkedin.com/in/felipelincoln/';
    ...
    <div className="w-full bg-zinc-900">
      <div className="flex flex-wrap gap-4 p-8 justify-between text-zinc-400">
        ...
        <div className="flex flex-col">
          ...
          >
            {config.web3.seaport.contract}
          </ExternalLink>
        </div>
        <div className="flex flex-col">
          <div className="font-bold">Contact</div>
          <div>collectoor.felipelincoln@gmail.com</div>
        </div>
        <div className="flex flex-col">
          <div className="font-bold">Socials</div>
          <div className="flex gap-2">
            <a target="_blank" href={collectoorLinkedin} className="text-zinc-300">
              <LinkedinIcon />
            </a>
            <a target="_blank" href={collectoorTwitter} className="text-zinc-300">
              <XIcon />
            </a>
          </div>
        </div>
